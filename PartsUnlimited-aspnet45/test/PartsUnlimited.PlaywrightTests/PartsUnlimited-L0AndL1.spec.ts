...
test('Verify Subsidiary Name On Home Page @LEVEL_0', async ({ page }) => {

    // Home Page
    await expect(page.locator('text=' + subsidiaryName).first()).toBeVisible();
});
  
test('Verify Subsidiary Name On Store Page @LEVEL_0', async ({ page }) => {
...
test('Verify Subsidiary Name On Login Page @LEVEL_0', async ({ page }) => {
...
test('Verify Subsidiary Name On ShoppingCart Page @LEVEL_0', async ({ page }) => {
...
test('Verify Subsidiary Name On Product Pages @LEVEL_1', async ({ page }) => {
